...
model_config = {
    ...
    "model_architecture": {
        ...
        "attention_heads": 8,
        "classifier_layers": [
            {"type": "LayerNorm", "size": 1536},
            {"type": "Linear", "input": 1536, "output": 384},
            {"type": "GELU"},
            {"type": "Dropout", "rate": 0.15},
            {"type": "Linear", "input": 384, "output": 128},
            {"type": "GELU"},
            {"type": "Dropout", "rate": 0.15},
            {"type": "Linear", "input": 128, "output": 5}
        ]
    },
    
    "training_config": {
        "focal_loss": {
            "alpha": [1.3515, 0.8599, 1.2265, 0.3183, 1.2438],
            "gamma": 2.0
        },
        "learning_rate": 5e-5,
        "weight_decay": 0.01,
    ...
    "data_config": {
        "emotions": ["anger", "joy", "melancholy", "neutral", "surprise"],
        "label2id": {
            "anger": 0,
            "joy": 1,
            "melancholy": 2,
...
config_file_path = "focal_attention_emotion_model_config.json"
with open(config_file_path, 'w', encoding='utf-8') as f:
    json.dump(model_config, f, indent=2, ensure_ascii=False)

print(f"✅ Model configuration saved to: {config_file_path}")
print("📋 This JSON file contains all information needed to recreate and use your model!")
